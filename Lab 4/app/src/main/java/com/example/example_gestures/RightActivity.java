...
public class RightActivity extends Activity implements
            ...
            if (Math.abs(diffX) > Math.abs(diffY)) {
                if (Math.abs(diffX) > SWIPE_THRESHOLD && Math.abs(velocityX) > SWIPE_VELOCITY_THRESHOLD) {
                    if (diffX > 0) {
                        ...
                        Intent myIntent = new Intent(RightActivity.this, LeftActivity.class);
                        startActivity(myIntent);
                    } else {
                        Toast.makeText(getApplicationContext(), "Swipe Left." , Toast.LENGTH_SHORT).show();
                        Intent myIntent = new Intent(RightActivity.this, MainActivity.class);
                        startActivity(myIntent);
                    }
                    result = true;
                }
                ...
                if (diffY > 0) {
                    ...
                    //Intent myIntent = new Intent(DownActivity.this, UpActivity.class);
                    //startActivity(myIntent);
                } else {
                    Toast.makeText(getApplicationContext(), "Swipe Up." , Toast.LENGTH_SHORT).show();
                    //Intent myIntent = new Intent(DownActivity.this, MainActivity.class);
                    //startActivity(myIntent);
                }
                result = true;
            }
